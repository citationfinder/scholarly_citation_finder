...
class CitationFinder(Process):
    ...
    def __init__(self, name, database_name='mag'):
        ...
        self.output = open(os.path.join(self.download_dir, '{}.csv'.format(name)))
